...
async function addCookieBanner() {
    ...
    if(!about_button) {
				console.log("ila-about-cookies-btn not found. Checking for ot-sdk-btn");
        about_button = document.getElementById("ot-sdk-btn");
    }
    ...
    if (data_fetch != "no") {
        ...
        if (!banner_content.includes("Cookie Notice")) {
            ...
            return;
            /* Prevents showing any S3 error messages at the end of every
                                  campus webpage. */
        }
